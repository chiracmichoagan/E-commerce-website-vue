<template>
  <div class="chat-bot-container ">
    ...
    <button
      @click="toggleChat"
      class="chat-bot-button fixed bottom-6 right-6 bg-primary-500 hover:bg-primary-600 text-white rounded-full w-50 h-20 flex items-center justify-center shadow-lg transition-all z-40"
      :class="{ 'rotate-45': isChatOpen }"
    >
      <i
        :name="isChatOpen ? 'i-heroicons-x-mark' : 'i-heroicons-chat-bubble-left-right'"
        class="text-2xl"
      />
      <!-- <i class="fa fa-xmark"></i> -->
      <i class="fa fa"></i>rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr
